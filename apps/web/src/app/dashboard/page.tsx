  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col md:flex-row font-sans">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-10 overflow-y-auto">
        ...
        {/* Chat Tab */}
        {activeTab === 'chat' && (
          <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-4 sm:p-6 shadow-2xl transition-all duration-500 min-h-[600px] flex flex-col md:flex-row gap-6">
            
            {/* Lista de Conversaciones */}
            <div className="w-full md:w-1/3 flex flex-col gap-4 border-b md:border-b-0 md:border-r border-slate-800 pb-4 md:pb-0 md:pr-6">
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <MessageSquare className="w-6 h-6 text-emerald-400" /> Conversaciones
              </h2>
              <div className="flex-1 overflow-y-auto space-y-2 pr-2 custom-scrollbar max-h-[300px] md:max-h-none">
            ...
            {/* Chat Box */}
            <div className="w-full md:w-2/3 flex flex-col bg-slate-950/50 rounded-2xl border border-slate-800 relative overflow-hidden min-h-[450px]">
              {!selectedConversationId ? (
                ...
                <>
                  {/* Chat Header with Human Mode Toggle */}
                  {(() => {
                    ...
                    return (
                      <div className="p-4 border-b border-slate-800 bg-slate-900/90 flex items-center justify-between flex-wrap gap-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-bold text-sm text-slate-100">{activeConv?.customerPhone}</h3>
                        ...
                        {/* Toggle Button for Manual Messages / Human Mode */}
                        <button
                  ...
                  <div className="p-4 border-t border-slate-800 bg-slate-900/80">
                    <form onSubmit={handleSendMessage} className="flex gap-3">
                      <input 
                        ...
                        placeholder="Escribe un mensaje como agente (activará automáticamente el modo manual)..."
                      ...
                      <button 
                        ...
                        className="bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed text-slate-950 font-bold px-5 py-3 rounded-xl flex items-center justify-center transition-colors shadow-lg"
                      >

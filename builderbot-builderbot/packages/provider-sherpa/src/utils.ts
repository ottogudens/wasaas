...
// Alias for sherpa compatibility
const sherpaCleanNumber = baileyCleanNumber
const sherpaGenerateImage = baileyGenerateImage
const sherpaIsValidNumber = baileyIsValidNumber
